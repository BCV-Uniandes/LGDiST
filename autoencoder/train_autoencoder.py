...
# Save model
if not os.path.exists(os.path.join("/media/SSD4/dvegaa/autoencoder/c_d_deltas", f"{args.dataset}")):
    os.makedirs(os.path.join("/media/SSD4/dvegaa/autoencoder/c_d_deltas", f"{args.dataset}"))

trainer.save_checkpoint(os.path.join("/media/SSD4/dvegaa/autoencoder/c_d_deltas", f"{args.dataset}", "autoencoder_model.ckpt"))
