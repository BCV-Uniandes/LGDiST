...
def get_main_parser():
    ...
    parser.add_argument('--partial',                        type=str2bool,          default=True,                            help='Set to True to perform partial completion during inference.')
    parser.add_argument('--masking_method',                 type=str,               default='prob_median',                   help='Available options: mask_prob, prob_median, scale_factor.')
