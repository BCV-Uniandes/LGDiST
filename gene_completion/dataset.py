...
class SpaREDData():
    ...
    def load_data(self):
        self.adata_path = f"/media/SSD0/pcardenasg2/c_dif_layers/datasets/1024/{self.dataset_name}_1024.h5ad" #TODO: adata 1024
        #self.adata_path = f"/media/SSD0/pcardenasg2/c_dif_layers/datasets/original/{self.dataset_name}.h5ad"
        ...
        self.original_adata_path = f"/media/SSD0/pcardenasg2/c_dif_layers/datasets/original/{self.dataset_name}.h5ad"
